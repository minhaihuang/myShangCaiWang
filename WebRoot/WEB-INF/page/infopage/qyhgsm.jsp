   ...
   <div class="AllWrapInside clearfix">
      <div class="mainColumn pageMain pagear">
         ...
         <div style="overflow: hidden; margin-left: 190px;">
            <div id="637">
               <p>
                  <strong><font color="#38761d" size="3"><br>企业惠购</font></strong>
               </p>
               <p>
                  <font size="3">我们提供的企业惠购版块，提供礼卡礼券、宅配服务等琳琅满目的商品，满足企事业单位的高管福利、员工激励、会议礼品等需求。具体订购方法如下：</font>
               </p>
               <p>
                  <strong><font color="#ff0000" size="3">在线订购</font></strong>
               </p>
               <p>
                  <font color="#000000" size="3">1)注册成为上菜网会员。<br>2)在企业惠购专区挑选符合您需求的产品，加入购物车。<br>3)修改产品数量。<br>4)下订单并进行结算。<br>5)等待物流配送。 </font>
               </p>
               <p>
                  <br> <font size="3"><font color="#ff0000"><strong>电话咨询订购</strong></font><br>1.拨打企业惠购咨询热线：4006-673-573。<br>2.告知您的企业需要购买的商品和数量，您也可以告知我们的客服关于订购方面的需求，例如：计划给员工发放福利，数量为500份，单份预算不超过100元。<br>3.客服人员会给您相应合理的建议。<br>4.达成一致后，与贵公司签订团购协议。<br>5.支付预付款项（30%），待我司提供货物并由贵公司签收后，向我司支付剩余的订单款项。</font>
               </p>
            </div>
         </div>
      </div>
