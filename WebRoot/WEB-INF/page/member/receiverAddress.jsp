         ...
         <div class="MemberCenter">
            ...
            <div class="MemberMain">
               <div style="margin-right: 175px;">
                  ...
                  <span>
                     <a class="lnk" href="?member-addReceiver.jsp">
                        <img src="/myShangCaiWang/themes/green/btn-addaddress.gif">
                     </a>
                  </span>
                  <table width="100%" class="memberlist" border="0" cellspacing="0" cellpadding="0">
                     <tbody>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td><a href="${pageContext.request.contextPath}/member/myCountAction_updateAddress.action?addressId=<s:property value="%{#address.addressId}"/>"><s:property value="%{#address.userName}"/></a></td>
                              <td class="textwrap" style="text-align: left;"><s:property value="%{#address.location}"/></td>
                              <td><s:property value="%{#address.phone}"/></td>
                              <td><s:property value="%{#address.mobile}"/></td>
                              <td><s:property value="%{#address.postNumber}"/></td>
                              
                              <td><a href="${pageContext.request.contextPath}/member/myCountAction_updateAddress.action?addressId=<s:property value="%{#address.addressId}"/>">修改</a>&nbsp;&nbsp;
                              <a href="${pageContext.request.contextPath}/member/myCountAction_deleteAddress.action?addressId=<s:property value="%{#address.addressId}"/>">删除</a></td>
                           </tr>
                           </s:iterator>
                        </tbody>
                  </table>
