...
<html>
  ...
  <body>
    <div class="siteparttitle">
               ...
               <div class="info">
                  <strong>您好：${session.user.userName }</strong>&nbsp;&nbsp;[
                  ...
                  <div class="body">
                     <ul>
                        ...
                        <li class="MemberMenuList"><span>
                           ...
                           <ul>
                              <li><a href="${pageContext.request.contextPath }/member/myCountAction_memberInfo.action" target="_self">个人信息</a></li>
                              <li><a href="${pageContext.request.contextPath }/member/myCountAction_passwordUpdate.action" target="_self">修改密码</a></li>
                              <li><a href="${pageContext.request.contextPath }/member/myCountAction_receiverAddress.action" target="_self">收货地址</a></li>
                           </ul></li>
                     </ul>
                  </div>
                  <div class="foot"></div>
